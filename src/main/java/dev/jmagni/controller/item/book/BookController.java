package dev.jmagni.controller.item.book;

import dev.jmagni.controller.item.book.form.BookAddForm;
import dev.jmagni.controller.item.book.form.BookDeleteForm;
import dev.jmagni.controller.item.book.form.BookUpdateForm;
import dev.jmagni.model.item.book.Book;
import dev.jmagni.model.item.book.dto.BookDto;
import dev.jmagni.model.member.Member;
import dev.jmagni.model.member.role.MemberRole;
import dev.jmagni.repository.item.BookRepository;
